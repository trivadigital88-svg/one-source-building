...
export default function AboutPage({ onOpenQuoteModal }) {
  ...
  return (
    <div className="pt-10 sm:pt-14 lg:pt-16 pb-20 font-sans animate-fadeIn">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ElementorBadge widgetName="one_source_about" shortcode='[one_source_section id="about_us"]' />

        {/* Hero Header */}
        <div className="bg-onyx-950 text-white rounded-3xl p-10 lg:p-20 relative overflow-hidden border border-gold-500/30 shadow-2xl mb-16">
